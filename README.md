...
![image](https://github.com/HectorCardoso53/Atividade_Aws-Linux/assets/118605794/1cf4898f-7c83-4093-af7a-3eff39a94a94)
...
4.	No próximo passo terá que ser mudado a regra para somente leitura para que somente o usuário possa vê essa chave, usando _``o comando chmod 400 e caminho da chave``_;
